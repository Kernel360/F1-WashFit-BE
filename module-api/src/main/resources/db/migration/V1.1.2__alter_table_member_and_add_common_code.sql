...
ALTER TABLE public."member" DROP COLUMN birthdate;
ALTER TABLE public."member" DROP COLUMN gender;
ALTER TABLE public."member" ADD COLUMN age int;
ALTER TABLE public."member" ADD COLUMN gender int;
...
SELECT member_no,
       id,
       encode(pgp_sym_decrypt(password, 'waihedpas')::bytea, 'escape') as password,
       encode(pgp_sym_decrypt(email, 'waihedpas')::bytea, 'escape')    as email,
       gender,
       age,
       created_at,
       created_by,
...
VALUES (nextval('member_member_no_seq'::regclass), NEW.id, pgp_sym_encrypt(NEW.password::TEXT, 'waihedpas'),
        pgp_sym_encrypt(NEW.email::TEXT, 'waihedpas'), NEW.gender, NEW.age, NEW.created_at, NEW.created_by,
...
UPDATE member
SET id          = NEW.id,
    "password"  = pgp_sym_encrypt(NEW.password::TEXT, 'waihedpas'),
    email       = pgp_sym_encrypt(NEW.email::TEXT, 'waihedpas'),
    gender      = NEW.gender,
    age         = NEW.age,
...
VALUES (1, 'carbrand', 0, '', 1, false, '차량 브랜드', '2023-12-28', 'admin', NULL, NULL),
...
INSERT INTO public.common_code (code_no, code_name, upper_no, upper_name, sort_order, is_used, description, created_at,
                                created_by, modified_at, modified_by)
VALUES (10, 'cartype', 0, '', 2, true, '차량 유형', '2023-12-28', 'admin', NULL, NULL),
...
INSERT INTO public.common_code (code_no, code_name, upper_no, upper_name, sort_order, is_used, description, created_at,
                                created_by, modified_at, modified_by)
VALUES (20, 'color', 0, '', 4, true, '차량 색상', '2023-12-28', 'admin', NULL, NULL),
       (21, 'white', 20, 'color', 1, true, '흰색', '2023-12-28', 'admin', NULL, NULL),
       (22, 'gray', 20, 'color', 5, true, '쥐색', '2023-12-28', 'admin', NULL, NULL),
       (23, 'black', 20, 'color', 6, true, '검정색', '2023-12-28', 'admin', NULL, NULL),
       (24, 'red', 20, 'color', 4, true, '빨간색', '2023-12-28', 'admin', NULL, NULL),
       (25, 'yellow', 20, 'color', 2, true, '노란색', '2023-12-28', 'admin', NULL, NULL),
       (26, 'green', 20, 'color', 3, true, '초록색', '2023-12-28', 'admin', NULL, NULL),
       (27, 'blue', 20, 'color', 4, true, '파란색', '2023-12-28', 'admin', NULL, NULL),
       (28, 'etc', 20, 'color', 7, true, '기타', '2023-12-28', 'admin', NULL, NULL),
       (29, 'perl', 0, '', 5, true, '차량 페인트 펄', '2023-12-28', 'admin', NULL, NULL);
INSERT INTO public.common_code (code_no, code_name, upper_no, upper_name, sort_order, is_used, description, created_at,
                                created_by, modified_at, modified_by)
VALUES (30, 'TRUE', 28, 'perl', 1, true, '있음', '2023-12-28', 'admin', NULL, NULL),
...
INSERT INTO public.common_code (code_no, code_name, upper_no, upper_name, sort_order, is_used, description, created_at,
                                created_by, modified_at, modified_by)
VALUES (40, 'house', 38, 'parking', 1, true, '실내/지하', '2023-12-28', 'admin', NULL, NULL),
       ...
       (44, 'outercare', 42, 'washInfo', 1, true, '도장', '2023-12-28', 'admin', NULL, NULL),
       (45, 'tire', 42, 'washInfo', 2, true, '타이어', '2023-12-28', 'admin', NULL, NULL),
       (46, 'wheel', 42, 'washInfo', 3, true, '휠', '2023-12-28', 'admin', NULL, NULL),
       (47, 'innercare', 42, 'washInfo', 4, true, '실내', '2023-12-28', 'admin', NULL, NULL),
       (48, 'gender', 0, NULL, 10, true, NULL, '2024-01-10', 'admin', NULL, NULL),
       (49, 'man', 48, 'gender', 1, true, '남성', '2024-01-10', 'admin', NULL, NULL);
INSERT INTO public.common_code (code_no, code_name, upper_no, upper_name, sort_order, is_used, description, created_at,
                                created_by, modified_at, modified_by)
VALUES (50, 'woman', 48, 'gender', 2, true, '여성', '2024-01-10', 'admin', NULL, NULL),
...
INSERT INTO public.common_code (code_no, code_name, upper_no, upper_name, sort_order, is_used, description, created_at,
                                created_by, modified_at, modified_by)
VALUES (60, 'month3', 57, 'frequency', 3, true, '월 평균 3회', '2024-01-10', 'admin', NULL, NULL),
