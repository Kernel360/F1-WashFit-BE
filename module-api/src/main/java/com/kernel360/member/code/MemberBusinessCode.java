...
public enum MemberBusinessCode implements BusinessCode {
    ...
    SUCCESS_REQUEST_RESET_PASSWORD_PAGE(HttpStatus.OK.value(), "BMC013", "액세스 토큰이 유효하므로 비밀번호 초기화 페이지로 접근에 성공합니다."),
    SUCCESS_REQUEST_RESET_PASSWORD(HttpStatus.OK.value(), "BMC014", "비밀번호가 성공적으로 초기화되었습니다."),
