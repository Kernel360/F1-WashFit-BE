...
//                .andExpect(jsonPath("$.value.content[*].productName", containsString(keyword)))
//                .andExpect(jsonPath("$.value.content[*].reportNumber", notNullValue()))
//                .andExpect(jsonPath("$.value.content[*].safetyStatus", equalTo("CONCERN")))
//                .andExpect(jsonPath("$.value.content[*].viewCount", equalTo(0)))
//                .andExpect(jsonPath("$.value.content[*].brand", equalTo("(주) 불스원")))
//                .andExpect(jsonPath("$.value.content[*].upperItem", notNullValue()))
//                .andExpect(jsonPath("$.value.content[*].createdAt", notNullValue()))
//                .andExpect(jsonPath("$.value.content[*].createdBy", notNullValue()))
//                .andExpect(jsonPath("$.value.content[*].modifiedAt", notNullValue()))
//                .andExpect(jsonPath("$.value.content[*].modifiedBy", notNullValue()))
//                .andExpect(jsonPath("$.value.totalPages", equalTo(20)))
//                .andExpect(jsonPath("$.value.totalElements", equalTo(196)))
//                .andExpect(jsonPath("$.value.last", equalTo(false)))
//                .andExpect(jsonPath("$.value.number", equalTo(5)))
//                .andExpect(jsonPath("$.value.size", equalTo(10)))
//                .andExpect(jsonPath("$.value.numberOfElements", equalTo(10)))
//                .andExpect(jsonPath("$.value.first", equalTo(false)))
//                .andExpect(jsonPath("$.value.empty", equalTo(false)))
