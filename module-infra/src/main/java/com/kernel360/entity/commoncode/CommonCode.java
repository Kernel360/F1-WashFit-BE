...
import com.kernel360.entity.base.BaseEntity;
...
public class CommonCode extends BaseEntity {
    ...
    @Column(name = "sub_description", length = Integer.MAX_VALUE)
    private String subDescription;

    //TODO BUILDER -> RETURN NEW PATTERN
    @Builder
    public CommonCode(Integer codeNo, String codeName, Integer upperNo, String upperName, Integer sortOrder, Boolean isUsed, String description, String subDescription) {
