...
public record ProductDto(String productName, String barcode, String imageSource,
                         ...
                         String productType, LocalDate issuedDate,
                         ...
                         String manufactureMethod, String manufactureNation, String violationInfo
) {
    ...
    public static Product toEntity(ProductDto productDto) {
        return Product.of(productDto.productName, productDto.barcode(), productDto.imageSource(),
                ...
                productDto.manufactureNation(), productDto.violationInfo());
    }
